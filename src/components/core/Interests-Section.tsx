...
import { Sparkles, Terminal, Layers, Eye, Globe, ArrowUpRight } from "lucide-react";
                ...
                >
                    {interestsData.map((interest, idx) => {
                        ...
                        return (
                            ...
                            >
                                {/* Ambient Aura */}
                                <div className="absolute inset-0 rounded-2xl transition-opacity duration-700 pointer-events-none opacity-0 group-hover:opacity-100 bg-linear-to-br from-[#00C9FF]/3 to-[#92FE9D]/3" />
